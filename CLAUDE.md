...
Stato: 21 commit su `main`, working tree pulito, nessun remote.
...
<body>
  ...
  <div class="deck">  40 × <div class="slide" data-slide="N" data-chapter="C">
...
versione** di `storageKey` (adesso `oltre-il-vibe-coding-edits-v6`), altrimenti vecchi testi
...
Compare **tre volte** con lo stesso disegno e centro diverso: completo (slide 21 del
contatore), col buco del contesto (27), col grafo che lo riempie (30). Il richiamo funziona
...
Segnaposto da riempire prima del talk (elenco completo nel README):

- slide 1 — nome, ruolo, team, data
- slide 5 — il dato di adozione `__ %` **con fonte verificata**
- slide 18-20 — i tre deep dive, coi ruoli realmente usati
- slide 21 — la matrice delle skill
- slide 23-25 — il walkthrough: task, output per agente, i tre numeri
- slide 29 — Graphify e llm-wiki: cosa fanno, integrazione, maturità
- slide 32-33 — link, QR code, contatto interno
